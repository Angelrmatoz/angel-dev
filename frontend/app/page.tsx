                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
                        ...
                        <section className="max-w-xl mx-auto lg:mx-0">
                            ...
                            <div className="mt-6 space-y-4 text-gray-300">
                                <p>
                                    Soy desarrollador web con pasión por construir interfaces intuitivas y código
                                    limpio. Mi
                                ...
                                <p>
                                    Me especializo en frontend con React (Next.js/Vite) y desarrollo móvil con React
                                    Native,
                                    y he expandido mis habilidades hacia el backend con Node.js, Express y GraphQL.
                                    Trabajo
